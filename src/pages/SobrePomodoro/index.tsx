      ...
      <MainTemplate>
         <Container>
            <GenericHtml>
               ...
               <h2>
                  Mas no <strong>aqui</strong> tem um diferencial 🚀
               </h2>
               ...
               <p>
                  ...
                  <RouterLink href='/historico/'>histórico</RouterLink>, com
                  status de completas ou interrompidas. Assim, você consegue
                  acompanhar sua evolução ao longo do tempo.
               </p>

               <h2>Por que usar o Pomodoro?</h2>
               <ul>
